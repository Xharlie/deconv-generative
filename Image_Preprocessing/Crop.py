...
def load_and_crop_write(folder, counter, imgCounter,info):
  ...
  for filename in os.listdir(folder):
    ...
    if img is not None:
      ...
      img_processed /= 255
      info["data"][imgCounter] = img_processed
...
def main():
  counter = 0
  imgCounter = 0
  info = {"data"   : np.full((86366, 64, 64, 3), 0, dtype=np.float16),
  ...
  with h5py.File(LABEL_FOLDER_PREFIX + 'all_info1.h5', 'w') as f:
    f['data'] = info['data'][:46366]
    f['onehot'] = info['onehot'][:46366]
    f['angles'] = info['angles'][:46366]
  with h5py.File(LABEL_FOLDER_PREFIX + 'all_info2.h5', 'w') as f:
    f['data'] = info['data'][46366:86366]
    f['onehot'] = info['onehot'][46366:86366]
    f['angles'] = info['angles'][46366:86366]
